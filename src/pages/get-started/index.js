...
class GetStarted extends React.Component {
    render() {
        ...
        const postsweb = data.web.edges
        const postsnode = data.node.edges
        const postsminiapp = data.miniapp.edges
                ...
                <Layout>
                    ...
                    <div className="py-6 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3">
                            <div className="mx-1 overflow-hidden cursor-pointer">
                                <div className="gs-browser-web h-36">
                                    ...
                                    <div className="px-4 mt-14 mr-4 mb-2">
                                        <p className="text-white">
                                            Ready to dive in?
                                        </p>
                                    </div>
                                </div>
                                <div className="gs-l h-48 mb-4">
                                    <div className="mt-4 mx-4 text-sm text-nn-tgray1 mb-2">Practical step-by-step guides to help you run machine learning models on browser.</div>
                                    <ul className="gs-ul mx-4 text-sm">
                                        {postsweb.map(({ node }, index) => {
                            ...
                            <div className="mx-1 overflow-hidden cursor-pointer">
                                <div className="gs-browser-node h-36">
                                    <div className="flex justify-between items-center ml-4">
                                ...
                                <div className="gs-l h-48 mb-4">
                                    <div className="mt-4 mx-4 text-sm text-nn-tgray1 mb-2">Build your Node.js or Electron.js applications with WebNN API support.</div>
                                    <ul className="gs-ul mx-4 text-sm">
                                        {postsnode.map(({ node }, index) => {
                                            const title = node.frontmatter.title || node.fields.slug
                                            return (
                                                <li key={index} className="gs-li overflow-ellipsis">
                                                    <svg className="text-nn-t1 w-3 h-4 mb-1 inline-block mr-2" viewBox="0 0 384 512">
                            ...
                            <div className="mx-1 overflow-hidden cursor-pointer">
                                <div className="gs-browser-wechat h-36">
                                    <div className="flex justify-between items-center ml-4">
                                    ...
                                    <div className="px-4 mt-14 mr-4 mb-2">
                                        <p className="text-white">
                                            For Tencent and other small programs
                                        </p>
                                    </div>
                                </div>
                                <div className="gs-l h-48 mb-4">
                        ...
                        {/* <div className="flex justify-center items-center">
                            <div className="mx-2 flex-col pt-4 justify-start w-72 sm:w-96 h-48 overflow-hidden cursor-pointer gs-l">
                            ...
                            <div className="mx-2 flex flex-col pt-4 justify-start w-72 sm:w-96 h-48 overflow-hidden cursor-pointer gs-l">
                                <div className="gs-ul ml-4 text-sm text-nn-tgray1 mb-2">Build your Node.js or Electron.js applications with WebNN API support.</div>
                                <ul className="gs-ul ml-4 text-sm">
                                    {postsnode.map(({ node }, index) => {
                                        const title = node.frontmatter.title || node.fields.slug
                                        return (
...
export const pageQuery = graphql`
  query {
    web:allMdx(sort: { fields: [frontmatter___date], order: DESC }
  ...
  node:allMdx(sort: { fields: [frontmatter___date], order: DESC }
  ...
  miniapp:allMdx(sort: { fields: [frontmatter___date], order: DESC }
