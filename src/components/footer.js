...
export default function Footer() {
  return ( 
    <footer className="bg-gray-900 text-white pt-12 pb-8 px-4">
        <div className="mx-auto px-4 container overflow-hidden flex flex-col lg:flex-row justify-between">
            ...
            <div className="w-2/3 block sm:flex text-sm mt-6 lg:mt-0">
                <ul className="text-gray-700 list-none p-0 font-thin flex flex-col text-left w-full">
                    ...
                    <li><a href="#" className="inline-block py-2 px-3 text-gray-500 hover:text-white no-underline">WebNN Native</a></li>
                    <li><a href="#" className="inline-block py-2 px-3 text-gray-500 hover:text-white no-underline">Demos</a></li>
                    <li><a href="#" className="inline-block py-2 px-3 text-gray-500 hover:text-white no-underline">Workload</a></li>
                </ul>
                <ul className="text-gray-700 list-none p-0 font-thin flex flex-col text-left w-full">
                    <li className="inline-block py-2 px-3 text-white uppercase font-medium tracking-wide">Community</li>
                    <li><a href="#" className="inline-block py-2 px-3 text-gray-500 hover:text-white no-underline">Blog</a></li>
                    <li><a href="#" className="inline-block py-2 px-3 text-gray-500 hover:text-white no-underline">Specs</a>
                    </li>
                    <li><a href="#" className="inline-block py-2 px-3 text-gray-500 hover:text-white no-underline">W3C Working Group</a></li>
                ...
                <ul className="text-gray-700 list-none p-0 font-thin flex flex-col text-left w-full">
                    ...
                    <li><a href="#" className="inline-block py-2 px-3 text-gray-500 hover:text-white no-underline">Getting Started</a></li>
        ...
        <div className="pt-4 mt-4 pt-6 text-white-600 border-t border-gray-800 text-center">&copy; 2021 Web Neural Network API</div>
    </footer>
  )
}